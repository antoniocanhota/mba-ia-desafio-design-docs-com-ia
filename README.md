...
5. **Tracker apontando pro momento errado.** Quando uma decisão era discutida no meio da reunião e só reafirmada no resumo final, o tracker citava a discussão inicial em vez da confirmação. Ajustei a regra de preenchimento do `docs/TRACKER.md` para sempre priorizar a fala que efetivamente fecha a decisão.
