...
**Contagem.** Foram cerca de **12 iterações principais** ao longo do pacote: 1 correção de rota + 4 refinamentos no comando de ADRs, 1 no RFC, 3 no FDD, 2 no PRD e 1 varredura final de consistência. Nenhuma delas veio de rodar e aceitar — todas vieram de revisar criticamente a saída contra a transcrição, o código e os critérios de aceite.
